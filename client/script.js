...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/Nothing')
    .then(response => {
        console.log(response.data)
...
// CODE HERE
const querybutton = () =>{
    axios.get('http://localhost:3000/query-test?FirstName=Omar&LastName=Abdullah')
    .then(response => {
        console.log(response.data)
    })
...
querybtn.addEventListener('click',querybutton)
////////////////
//INTERMEDIATE//
////////////////
